...
Nos dice que por cada incremento del 1% en el costo de instalación del sistema Gas Central disminuye la probabilidad de que sea elegido en 0.052% aproximadamente.
...
Por cada aumento del 1% en el costo de operación del sistema Gas Central aumenta aproximadamente 0.039% tambien la probabilidad de que los consumidores elijan una alternativa diferente.
...
en general, estos resultados son  razonables. el resultado nos da que los costos de instalación y operación son negativos y a su vez significativos, lo cual es igual a la teoria que nos dice que a mayor costo, menor utilidad para los consumidores. 